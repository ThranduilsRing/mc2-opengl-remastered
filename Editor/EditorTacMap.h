/***************************************************************
* FILENAME: EditorTacMap.h
* DESCRIPTION: Declares the floating Editor tactical map dialog.
* AUTHOR: Microsoft Corporation
* COPYRIGHT: Copyright (C) Microsoft Corporation. All rights reserved.
* DATE: 04/28/2026
* MODIFICATION: by Methuselas
* CHANGES: Uses shared Editor tacmap display constants for the doubled tactical map window.
****************************************************************/
